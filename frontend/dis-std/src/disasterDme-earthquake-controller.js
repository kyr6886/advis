...
var vue = new Vue({
    ...
    data: function() {
        return {
            ...
            viewModel: {
                ...
                listTotalDmeChart: [],
                listSelectItem: [],
                listTopDmeCode: [{ code: "HZD017", code_name_dme: "지진" }],
                listTyphoonName: [],
                listDmeDateCode: [],
                listDmeSidoCode: [],
                listDmeGunguCode: [],
    ...
    methods: {
        ...
        fnGetCodeList: function(paramDmeCode) {
            ...
            Axios.post('/api/damage/history/code/earthquakeList.do', { paramYear: vm.viewModel.stDate })
                .then(function(response) {
                    if (response.data.listDmeDateCode != undefined && response.data.listDmeDateCode != null && response.data.listDmeDateCode.length > 0) {
                        ...
                        vm.viewModel.stDate = response.data.paramYear;
        ...
        fnOnClickBtnSearch: function() {
            ...
            if (vm.viewModel.selectDmeDate == '') {
                alert("지진 또는 날짜 전체를 선택하실 수 없습니다.");
                return false;
        ...
        fnGetDamageList: function(paramObj) {
            ...
            Axios.post("/api/damage/earthquake/area/detail.do", {
