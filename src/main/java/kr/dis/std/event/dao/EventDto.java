...
public class EventDto extends BaseDTO {
	...
	private String is_root_yn;
	private String is_cs_yn;
	
	
	
	
	public String getDis_act_date() {
		return dis_act_date;
	}
	public void setDis_act_date(String dis_act_date) {
		this.dis_act_date = dis_act_date;
	}
	public String getIs_root_yn() {
		return is_root_yn;
	}
	public void setIs_root_yn(String is_root_yn) {
		this.is_root_yn = is_root_yn;
	}
	public String getIs_cs_yn() {
		return is_cs_yn;
	}
	public void setIs_cs_yn(String is_cs_yn) {
		this.is_cs_yn = is_cs_yn;
	}
