...
<div id="container">
	...
	<div class="contents-wrap" id="scope-disasterDme" v-cloak>
		<ul class="tab">
			...
			<li class="on"><a href="/advis/disaster/earthquake">지진</a></li>
...
<!-- 		</div> -->
		...
		<div class="section-title"><ul><li>{{viewModel.selectedDamageGungu.sigungu}}의 지진 피해현황</li></ul></div>
		<div class="table-basic">
			<table>
...
<script	src="${pageContext.request.contextPath}/contents/advis/js/model/vue/disasterDmeEarthquake-controller.min.js?v=20190403"></script>
