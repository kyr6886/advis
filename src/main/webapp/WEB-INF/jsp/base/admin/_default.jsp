			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="/system/manage/default#/" class="site_title"><i class="fa fa-paw"></i>
							<span>Noaa Admin</span></a>
					</div>
                ...
                <h2>John Doe</h2>
					...
					<div id="sidebar-menu"
                      ...
                      <li><a href="index3.html">Dashboard3</a>
								...
								<li><a><i class="fa fa-edit"></i> 코드 <span
								...
								<li><a><i class="fa fa-table"></i> 게시판 관리 <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
								...
								<li>
									<a><i class="fa fa-external-link"></i> 관련 사이트 관리 <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a href="/account/logout?returnURI=/account/login">
